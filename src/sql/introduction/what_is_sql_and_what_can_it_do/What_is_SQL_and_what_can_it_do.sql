...
-- MAGIC ---
-- MAGIC This notebook is published along with the article ["What is SQL and what can it do" on Datalit](https://datalit.substack.com/p/what-is-sql-and-what-can-it-do?utm_campaign=post&utm_medium=web&utm_source=databricks). Make sure you [subscribe to Datalit](http://datalit.substack.com/?utm_campaign=post&utm_medium=web&utm_source=databricks) to receive all data literacy tutorials.
